...
export const decreaseCurrentNutsNumberActions = createAction("DECREASE_CURRENT_NUTS_NUMBER", action => {
    return (value: number) => action(value);
});
...
export const addDisableLevelsAction = createAction("ADD_DISABLE_LEVELS", action => {
    return (value: number[]) => action(value);
});
